...
def propose_amendment(
    ...
    *,
    ...
    description = (
        ...
        "existing contract declares evidence_mode, produces, or consumes, explicitly "
        "carry all three fields in the replacement, or set top-level "
        "clear_contract_boundary: true and omit all three fields to clear that typed "
        "boundary. "
        "Do not edit "
        "the live manifest.\n\n"
