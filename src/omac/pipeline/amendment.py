...
def propose_amendment(
    ...
    *,
    ...
    description = (
        ...
        "update-responsibility only for that historical escape hatch: carry only "
        "acceptance, acceptance_claims, acceptance_contributions, acceptance_refs, and "
        "optional named integration-gate acceptance_refs patches; never copy a complete "
        "contract. Active nodes keep using normal complete contract updates. Use "
        "migration.ownership_transfer=true plus a reason when an "
