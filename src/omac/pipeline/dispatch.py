...
def _validate_develop_authoring(
    ...
    """develop × authoring 左移校验:PR ready 门 + 复用 P2.2 validate_worker_evidence。"""
    # PR ready 门走引擎数据面(§12.4 红线:平台 CLI 调用只封装在引擎适配器内)。
    store.validate_pr_ready_for_handoff(pr_url)
