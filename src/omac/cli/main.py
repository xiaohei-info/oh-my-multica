...
_EN_SUBCOMMAND_HELP = {
    ...
    "continue-review": "Authorize exactly one additional plan-stage review round",
...
_EN_ARGUMENT_HELP = {
    ...
    "restart_authoring": "Fail closed and direct amendment recovery to a new auditable attempt",
    "topic": "Guide topic",
